...
def split_by_index_R0_G(l_R0: list, l_G: list, index_test: list):
    m = len(l_R0)
    index_test = index_test
    index_train=[index for index in range(0,m) if index not in index_test]
    l_R0_test = [ l_R0[index] for index in index_test ]
    l_R0_train = [ l_R0[index] for index in index_train ]
    l_G_test = [l_G[index] for index in index_test]
    l_G_train = [l_G[index] for index in index_train]
    return l_R0_train, l_R0_test, l_G_train, l_G_test
